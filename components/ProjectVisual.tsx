  ...
  return (
    <svg className="project-drawing" viewBox="0 0 640 560" aria-hidden="true">
      ...
      <g className="project-drawing__device draw-stroke">
        ...
        <path className="project-drawing__heart" d="M320 277c-62-34-87-62-87-103 0-35 25-58 57-58 18 0 33 8 43 23 10-15 25-23 43-23 32 0 57 23 57 58 0 41-25 69-113 103Z" />
  ...
  return (
    <svg className="project-drawing" viewBox="0 0 640 560" aria-hidden="true">
      <g className="project-drawing__sources draw-stroke">
        ...
        <path d="M65 116h62M65 136h83M65 151h48" />
        <rect x="470" y="116" width="128" height="76" rx="16" />
        <path d="M493 140h79M493 160h58M493 176h84" />
        <rect x="58" y="386" width="132" height="74" rx="16" />
        <path d="M81 410h78M81 430h53M81 446h86" />
      </g>
      ...
      <g className="project-drawing__scout draw-stroke">
        ...
        <path d="M278 154c-20 29-25 72-13 111M376 154c21 31 26 73 13 112" />
        <path d="M272 221c-15 33-13 58 4 79M382 221c15 33 13 58-4 79" />
        <path d="M276 166c0 62 17 92 51 92s52-30 52-92" />
        <path d="M278 184c-18 1-19 28 2 33M377 184c18 1 19 28-2 33" />
        <path d="M300 194h10M344 194h10M317 225c7 5 15 5 22 0" />
        <path d="M268 282c-42 22-60 75-60 137M387 282c42 22 60 75 60 137" />
        <path d="M278 273l49 46 49-46M327 319v169" />
      ...
      <text className="project-drawing__caption" x="510" y="455">DATA FOUND</text>
    </svg>
  );
}
